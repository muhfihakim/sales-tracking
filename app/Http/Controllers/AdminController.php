...
class AdminController extends Controller
{
    ...
    public function index7()
    {
        ...
        return view('admin.tambahTugas', compact('users', 'outlets'));
    }

    public function storeTugas(Request $request)
    {
        /*         // Tampilkan data request untuk debugging
        dd($request->all()); */

        $request->validate([
            'sales_id' => 'required|exists:users,id', // Ganti 'sales' menjadi 'users'
    ...
    public function index8(Task $task)
    {
        ...
        // Ambil semua tasks (tugas) dari sales ini
        $salesTasks = Task::where('sales_id', $task->sales_id)->get();
